...
class liga:
    ...
    def mostrar(self):
        self.equipos = sorted(self.equipos, key=lambda objeto: (-objeto.partidosganados, objeto.partidosperdidos, -objeto.puntosafavor, objeto.puntosencontra, -objeto.marcador, objeto.nombre))
